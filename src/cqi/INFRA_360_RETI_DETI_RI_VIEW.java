...
public class INFRA_360_RETI_DETI_RI_VIEW {
	WebDriver driver;
...
Thread.sleep(15000);
 		...
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 ...
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][31]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_RETI_RI_INFRA";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_RETI_RI_INFRA (REC_ID,QUERY_CD,CATEGORY_DATE,CFR) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+CFR_List.get(i)+"')";
 			System.out.println("");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		INFRA_360_RETI_DETI_RI_VIEW dna1= new INFRA_360_RETI_DETI_RI_VIEW(); 
		dna1.ifd();
