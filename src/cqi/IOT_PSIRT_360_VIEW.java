...
public class IOT_PSIRT_360_VIEW {
	WebDriver driver;
...
Thread.sleep(10000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[2]/div/div[9]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 js.executeScript("window.scrollBy(0,250)", "");
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][18]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
 		...
 		//public void openAndCloseSummaryReportExcel() throws AWTException {
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/eng-iot-all-_-psirt.xls");
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_CQI_PSIRT_IOT";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_CQI_PSIRT_IOT (REC_ID,QUERY_CD,CATEGORY_DATE,PSIRT_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+PSIRT_BacklogList.get(i)+"')";
 			System.out.println("");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		IOT_PSIRT_360_VIEW dna1= new IOT_PSIRT_360_VIEW(); 
		dna1.ifd();
