...
public class ROUTING_RI_360_VIEW {
...
Thread.sleep(15000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[3]/div/div[7]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		...
 		//public void openAndCloseSummaryReportExcel() throws AWTException {
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/eng-routing-all-_-regression-incoming.xls");
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_CQI_RI_ROUTING";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_CQI_RI_ROUTING (REC_ID,QUERY_CD,CATEGORY_DATE,CFR,IFR) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+CFR_List.get(i)+"','"+ IFR_List.get(i)+"')";
 			System.out.println("");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		ROUTING_RI_360_VIEW dna1= new ROUTING_RI_360_VIEW(); 
		dna1.ifd();
