...
public class ROUTING_360_RETI_DETI_CFD_VIEW {
	WebDriver driver;
...
Thread.sleep(10000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[3]/div/div[1]/div/div/div/a")).click();
 		Thread.sleep(2000);
       ...
       Thread.sleep(5000);
        ...
        Thread.sleep(6000);
         ...
         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
    	   ...
    	   String deletequery = "DELETE FROM OPSBI_360_RETI_CFD_ROUTING";
    	   ...
    	   System.out.println("5");
    		...
    		for(int i=0;i< categoryList.size();i++){	
    			...
    			String query = "INSERT INTO OPSBI_360_RETI_CFD_ROUTING (REC_ID,QUERY_CD,CATEGORY_DATE,CFD_AVERAGE,CFD_MTTR,CFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+categoryList.get(i)+"','"+ CFD_AverageList.get(i)+"','"+CFD_MttrList.get(i)+"','"+CFD_BacklogList.get(i)+"')";			
    			System.out.println("");
    			smt.executeQuery(query).close();
    		}
    		
    	
    		System.out.println("--- ORACLE Data Table  Inserted into Table OPSBI_360_RETI_CFD_ROUTING---");
	}
		...
		public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
			ROUTING_360_RETI_DETI_CFD_VIEW dna1= new ROUTING_360_RETI_DETI_CFD_VIEW(); 
		dna1.set_cqa_DNA();
