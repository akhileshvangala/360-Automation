...
public class SPA_PSIRT_360_VIEW {
...
Thread.sleep(10000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[6]/div/div[9]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 js.executeScript("window.scrollBy(0,250)", "");
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][54]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
 		...
 		//public void openAndCloseSummaryReportExcel() throws AWTException {
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/enb-spa-all-_-psirt.xls");
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_DTLS_VIEW_PSIRT_SPA";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_DTLS_VIEW_PSIRT_SPA (REC_ID,QUERY_CD,CATEGORY_DATE,PSIRT_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+PSIRT_BacklogList.get(i)+"')";
 			System.out.println("");
 			smt.executeQuery(query).close();
 		}
		
 	
 		System.out.println("--- ORACLE Data Table  Inserted into Table SPA PSIRT---");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		SPA_PSIRT_360_VIEW dna1= new SPA_PSIRT_360_VIEW(); 
		dna1.ifd();
