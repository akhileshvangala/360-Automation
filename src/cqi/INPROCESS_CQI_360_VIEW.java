         ...
         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
    	   ...
    	   System.out.println("5");
    		...
    		for(int i=0;i< categoryList.size();i++){	
    			...
    			String query = "INSERT INTO OPSBI_360_INPROCESS_VIEW (REC_ID,QUERY_CD,CATEGORY_DATE,TEST_ESC,DEV_ESC,DRE) VALUES ('"+(i+1)+"','D4,D5','"+categoryList.get(i)+"','"+ CFD_AverageList.get(i)+"','"+CFD_BacklogList.get(i)+"','"+CFD_MttrList.get(i)+"')";			
    			System.out.println("");
