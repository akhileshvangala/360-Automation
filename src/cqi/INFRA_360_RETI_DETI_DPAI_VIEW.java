	...
	public class INFRA_360_RETI_DETI_DPAI_VIEW {
		WebDriver driver;
	...
	Thread.sleep(10000);
	        ...
	        Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[2]/div/div[11]/div/div/div/a")).click();
			 
	 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][67]/li/a[@title='Trend']"));
	 		e1.click();
	       Thread.sleep(5000);
	        ...
	        Thread.sleep(6000);
	         ...
	         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
	    			...
	    			DateFormat df = new SimpleDateFormat("MM/dd/yyyy");
	    	         ...
	    	         String category = df.format(data1);
	    	          ...
	    	          categoryList.add(category);
	  	 			String CFD_Average = sheet1.getRow(i).getCell(2).toString();
	  	 			CFD_AverageList.add(CFD_Average);
	  	 			String CFD_Backlog = sheet1.getRow(i).getCell(1).toString();
	    	   ...
	    	   String deletequery = "DELETE FROM OPSBI_360_RETI_CFD_INFRA";
	    	   ...
	    	   System.out.println("5");
	    		...
	    		for(int i=0;i< categoryList.size();i++){	
	    			...
	    			String query = "INSERT INTO OPSBI_360_RETI_CFD_INFRA (REC_ID,QUERY_CD,CATEGORY_DATE,CFD_AVERAGE,CFD_MTTR,CFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+categoryList.get(i)+"','"+ CFD_AverageList.get(i)+"','"+CFD_MttrList.get(i)+"','"+CFD_BacklogList.get(i)+"')";			
	    			System.out.println("");
			...
			public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
				INFRA_360_RETI_DETI_DPAI_VIEW dna1= new INFRA_360_RETI_DETI_DPAI_VIEW(); 
			dna1.set_cqa_DNA();
