...
Thread.sleep(10000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[2]/div/div[2]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 js.executeScript("window.scrollBy(0,250)", "");
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][11]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
 		...
 		//Open downloaded file
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/eng-iot-all-_-cfd-mttr.xls");
        ...
        Thread.sleep(6000);
         ...
         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
    	   ...
    	   String deletequery = "DELETE FROM OPSBI_360_VIEW_CFD_IOT";
    	   ...
    	   System.out.println("5");
    		...
    		for(int i=0;i< categoryList.size();i++){	
    			...
    			String query = "INSERT INTO OPSBI_360_VIEW_CFD_IOT (REC_ID,QUERY_CD,CATEGORY_DATE,CFD_INCOMING,CFD_DISPOSED,CFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+categoryList.get(i)+"','"+ CFD_IncomingList.get(i)+"','"+CFD_DisposedList.get(i)+"','"+CFD_BacklogList.get(i)+"')";			
    			System.out.println("");
		...
		IOT_CFD_360_VIEW dna1= new IOT_CFD_360_VIEW(); 
		dna1.set_cqa_DNA();
