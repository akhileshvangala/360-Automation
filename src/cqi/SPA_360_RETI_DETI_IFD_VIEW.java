...
public class SPA_360_RETI_DETI_IFD_VIEW {
	WebDriver driver;
...
Thread.sleep(10000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[6]/div/div[4]/div/div/div/a")).click();
 		Thread.sleep(2000);
       ...
       Thread.sleep(5000);
        ...
        Thread.sleep(6000);
         ...
         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
    	   ...
    	   String deletequery = "DELETE FROM OPSBI_360_RETI_IFD_SPA";
    	   ...
    	   System.out.println("5");
    		...
    		for(int i=0;i< categoryList.size();i++){	
    			...
    			String query = "INSERT INTO OPSBI_360_RETI_IFD_SPA (REC_ID,QUERY_CD,CATEGORY_DATE,IFD_AVERAGE,IFD_MTTR,IFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+categoryList.get(i)+"','"+ IFD_AverageList.get(i)+"','"+IFD_MttrList.get(i)+"','"+IFD_BacklogList.get(i)+"')";			
    			System.out.println("");
    			smt.executeQuery(query).close();
    		}
    		
    	
    		System.out.println("--- ORACLE Data Table  Inserted into Table OPSBI_360_RETI_IFD_SPA---");
	}
		...
		public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
			SPA_360_RETI_DETI_IFD_VIEW dna1= new SPA_360_RETI_DETI_IFD_VIEW(); 
		dna1.set_cqa_DNA();
