...
public class SWITCHING_IFD_360_VIEW {
	WebDriver driver;
...
Thread.sleep(25000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[5]/div/div[6]/div/div/div/a")).click();
 		Thread.sleep(2000);
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_CQI_IFD_SWITCHING";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_CQI_IFD_SWITCHING (REC_ID,QUERY_CD,CATEGORY_DATE,IFD_INCOMING,IFD_DISPOSED,IFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+IFD_IncomingList.get(i)+"','"+ IFD_DisposedList.get(i)+"','"+IFD_BacklogList.get(i)+"')";
 			System.out.println("");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		SWITCHING_IFD_360_VIEW dna1= new SWITCHING_IFD_360_VIEW(); 
		dna1.ifd();
