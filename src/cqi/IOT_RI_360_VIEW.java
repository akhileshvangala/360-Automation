...
Thread.sleep(15000);
 		...
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 ...
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][16]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_CQI_RI_IOT";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_CQI_RI_IOT (REC_ID,QUERY_CD,CATEGORY_DATE,CFR,IFR) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+CFR_List.get(i)+"','"+ IFR_List.get(i)+"')";
 			System.out.println("");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		IOT_RI_360_VIEW dna1= new IOT_RI_360_VIEW(); 
		dna1.ifd();
