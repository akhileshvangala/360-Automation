...
public class WIRELESS_360_RETI_DETI_RI_VIEW {
	WebDriver driver;
...
Thread.sleep(15000);
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_RETI_RI_WIRELESS";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_RETI_RI_WIRELESS (REC_ID,QUERY_CD,CATEGORY_DATE,CFR) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+CFR_List.get(i)+"')";
 			System.out.println("");
 			smt.executeQuery(query).close();
 		}
		
 	
 		System.out.println("--- ORACLE Data Table  Inserted into Table RI WIRELESS---");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		WIRELESS_360_RETI_DETI_RI_VIEW dna1= new WIRELESS_360_RETI_DETI_RI_VIEW(); 
		dna1.ifd();
