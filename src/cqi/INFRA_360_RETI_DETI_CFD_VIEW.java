...
public class INFRA_360_RETI_DETI_CFD_VIEW {
	WebDriver driver;
...
Thread.sleep(10000);
       ...
       Thread.sleep(5000);
        ...
        Thread.sleep(6000);
         ...
         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
    	   ...
    	   System.out.println("5");
    		...
    		System.out.println("--- ORACLE Data Table  Inserted into Table OPSBI_360_RETI_CFD_INFRA---");
	}
		...
		public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
			INFRA_360_RETI_DETI_CFD_VIEW dna1= new INFRA_360_RETI_DETI_CFD_VIEW(); 
		dna1.set_cqa_DNA();
