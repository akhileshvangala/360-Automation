...
public class SPA_IFD_360_VIEW {
	...
	ArrayList<String> IFD_IncomingList = new ArrayList<String>();
	ArrayList<String> IFD_DisposedList = new ArrayList<String>();
	...
	//myFile = new File("C:\\Users\\akvangal\\Downloads\\test.xls");
		...
		driver.get("https://wwwin-cqi.cisco.com/cqi/widgetReport.htm?widgetId=WDGT-seetaram-3&primary=N&hierarchy=org&viewId=422&intervalType=week");
Thread.sleep(25000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[6]/div/div[6]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 js.executeScript("window.scrollBy(0,250)", "");
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][51]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
 		...
 		//public void openAndCloseSummaryReportExcel() throws AWTException {
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/enb-spa-all-_-ifd-mttr.xls");
        ...
        robot.keyRelease(KeyEvent.VK_F4);
 		...
 		for(int i=1; i<=rowCount; i++) {
 			...
 			String IFD_Incoming = sheet1.getRow(i).getCell(2).toString();
 			
 			IFD_IncomingList.add(IFD_Incoming);
 			String IFD_Disposed = sheet1.getRow(i).getCell(3).toString();
 			//int IFD_MTTR= (int)wb.getSheetAt(0).getRow(i).getCell(3).getNumericCellValue();
 			IFD_DisposedList.add(IFD_Disposed);
 		...
 		//System.out.println("Data from Excel is >>> "+data);
 			...
 			System.out.println(IFD_Incoming);
 			System.out.println(IFD_Disposed);
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_DTLS_VIEW_IFD_SPA";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_DTLS_VIEW_IFD_SPA (REC_ID,QUERY_CD,CATEGORY_DATE,IFD_INCOMING,IFD_DISPOSED,IFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+IFD_IncomingList.get(i)+"','"+ IFD_DisposedList.get(i)+"','"+IFD_BacklogList.get(i)+"')";
 			System.out.println("");
 			smt.executeQuery(query).close();
 		}
		
 	
 		System.out.println("--- ORACLE Data Table  Inserted into Table IFD SPA---");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		SPA_IFD_360_VIEW dna1= new SPA_IFD_360_VIEW(); 
		dna1.ifd();
