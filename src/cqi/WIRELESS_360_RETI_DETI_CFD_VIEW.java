...
public class WIRELESS_360_RETI_DETI_CFD_VIEW {
	WebDriver driver;
...
Thread.sleep(10000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[4]/div/div[1]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 js.executeScript("window.scrollBy(0,250)", "");
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][13]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(7000);
        ...
        Thread.sleep(6000);
         ...
         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
    	   ...
    	   String deletequery = "DELETE FROM OPSBI_360_RETI_CFD_WIRELESS";
    	   ...
    	   System.out.println("5");
    		...
    		for(int i=0;i< categoryList.size();i++){	
    			...
    			String query = "INSERT INTO OPSBI_360_RETI_CFD_WIRELESS (REC_ID,QUERY_CD,CATEGORY_DATE,CFD_AVERAGE,CFD_MTTR,CFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+categoryList.get(i)+"','"+ CFD_AverageList.get(i)+"','"+CFD_MttrList.get(i)+"','"+CFD_BacklogList.get(i)+"')";			
    			System.out.println("");
    			smt.executeQuery(query).close();
    		}
    		
    	
    		System.out.println("--- ORACLE Data Table  Inserted into Table OPSBI_360_RETI_CFD_WIRELESS---");
	}
		...
		public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
			WIRELESS_360_RETI_DETI_CFD_VIEW dna1= new WIRELESS_360_RETI_DETI_CFD_VIEW(); 
		dna1.set_cqa_DNA();
