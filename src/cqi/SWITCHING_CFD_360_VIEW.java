...
public class SWITCHING_CFD_360_VIEW {
	...
	ArrayList<String> category_CFD_List = new ArrayList<String>();
...
Thread.sleep(25000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[5]/div/div[2]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		...
 		//public void openAndCloseSummaryReportExcel() throws AWTException {
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/eng-campus-switching-all-_-cfd-mttr.xls");
        ...
        robot.keyRelease(KeyEvent.VK_F4);
 		...
 		for(int i=1; i<=rowCount; i++) {
 			...
 			DateFormat df = new SimpleDateFormat("MM/dd/yyyy");
 	         ...
 	         category_CFD_List.add(category_IFD);
 			String CFD_Backlog = sheet1.getRow(i).getCell(2).toString();
 			CFD_BacklogList.add(CFD_Backlog);
 			String CFD_Incoming = sheet1.getRow(i).getCell(1).toString();
 			
 			CFD_IncomingList.add(CFD_Incoming);
 			String CFD_Disposed = sheet1.getRow(i).getCell(3).toString();
 		...
 		//System.out.println("Data from Excel is >>> "+data);
 			...
 			System.out.println(CFD_Incoming);
 			System.out.println(CFD_Disposed);
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_VIEW_CFD_SWITCHING";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_CFD_List.size();i++){	
 			System.out.println("Here 6");			
 			String query = "INSERT INTO OPSBI_360_VIEW_CFD_SWITCHING (REC_ID,QUERY_CD,CATEGORY_DATE,CFD_INCOMING,CFD_DISPOSED,CFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_CFD_List.get(i)+"','"+CFD_IncomingList.get(i)+"','"+ CFD_DisposedList.get(i)+"','"+CFD_BacklogList.get(i)+"')";
 			System.out.println("");
 		...
 		System.out.println("--- ORACLE Data Table  Inserted into Table CFD SWITCHING---");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		SWITCHING_CFD_360_VIEW dna1= new SWITCHING_CFD_360_VIEW(); 
		dna1.ifd();
