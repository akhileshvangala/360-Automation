...
public class WIRELESS_IFD_360_VIEW {
...
Thread.sleep(25000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[4]/div/div[6]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 js.executeScript("window.scrollBy(0,250)", "");
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][33]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
        ...
        robot.keyRelease(KeyEvent.VK_F4);
 		...
 		for(int i=1; i<=rowCount; i++) {
 			...
 			String IFD_Backlog = sheet1.getRow(i).getCell(3).toString();
 			IFD_BacklogList.add(IFD_Backlog);
 			String IFD_Incoming = sheet1.getRow(i).getCell(1).toString();
 			
 			IFD_IncomingList.add(IFD_Incoming);
 			String IFD_Disposed = sheet1.getRow(i).getCell(2).toString();
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_CQI_IFD_WIRELESS";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_CQI_IFD_WIRELESS (REC_ID,QUERY_CD,CATEGORY_DATE,IFD_INCOMING,IFD_DISPOSED,IFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+IFD_IncomingList.get(i)+"','"+ IFD_DisposedList.get(i)+"','"+IFD_BacklogList.get(i)+"')";
 			System.out.println("");
 		...
 		System.out.println("--- ORACLE Data Table  Inserted into Table IFD SWITCHING---");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		WIRELESS_IFD_360_VIEW dna1= new WIRELESS_IFD_360_VIEW(); 
		dna1.ifd();
