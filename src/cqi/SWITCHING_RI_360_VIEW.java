...
public class SWITCHING_RI_360_VIEW {
...
Thread.sleep(15000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[5]/div/div[7]/div/div/div/a")).click();
 		Thread.sleep(2000);
 		
 		JavascriptExecutor js = (JavascriptExecutor) driver;
 		 js.executeScript("window.scrollBy(0,250)", "");
 		 Thread.sleep(4000);
 		WebElement e1 = driver.findElement(By.xpath("//html/body/ul[@id='hoverdiv'][43]/li/a[@title='Trend']"));
 		e1.click();
       Thread.sleep(5000);
 		...
 		//public void openAndCloseSummaryReportExcel() throws AWTException {
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/eng-campus-switching-all-_-regression-incoming.xls");
        ...
        robot.keyRelease(KeyEvent.VK_F4);
 		...
 		for(int i=1; i<=rowCount; i++) {
 			...
 			String IFR = sheet1.getRow(i).getCell(2).toString();
 			IFR_List.add(IFR);
 	  ...
 	  String deletequery = "DELETE FROM OPSBI_360_CQI_RI_SWITCHING";
 	  smt.executeQuery(deletequery).close();
 	   ...
 	   System.out.println("5");
 		...
 		for(int i=0;i< category_IFD_List.size();i++){	
 			...
 			String query = "INSERT INTO OPSBI_360_CQI_RI_SWITCHING (REC_ID,QUERY_CD,CATEGORY_DATE,CFR,IFR) VALUES ('"+(i+1)+"','"+queryCD+"','"+category_IFD_List.get(i)+"','"+CFR_List.get(i)+"','"+ IFR_List.get(i)+"')";
 			System.out.println("");
 			smt.executeQuery(query).close();
 		}
		
 	
 		System.out.println("--- ORACLE Data Table  Inserted into Table RI SPA---");
	...
	public static void main(String args[]) throws Exception, InterruptedException, SQLException, IOException {
		SWITCHING_RI_360_VIEW dna1= new SWITCHING_RI_360_VIEW(); 
		dna1.ifd();
