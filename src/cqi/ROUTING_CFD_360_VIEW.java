...
public class ROUTING_CFD_360_VIEW {
	WebDriver driver;
...
Thread.sleep(10000);
 		...
 		driver.findElement(By.xpath("//*[@class='reviewDirTabs']/div[2]/div/div[2]/div[2]/div/div[3]/div/div[2]/div/div/div/a")).click();
 		Thread.sleep(2000);
       ...
       Thread.sleep(5000);
 		...
 		//Open downloaded file
            ...
            if (Desktop.isDesktopSupported()) {
                   ...
                   try {
                          ...
                          File myFile1 = new File("C:/Users/" + System.getProperty("user.name") + "/Downloads/eng-routing-all-_-cfd-mttr.xls");
        ...
        Thread.sleep(6000);
         ...
         myFile = new File("C:\\Users\\akvangal\\AppData\\Roaming\\Microsoft\\AddIns\\test.xls");
    	   ...
    	   String deletequery = "DELETE FROM OPSBI_360_VIEW_CFD_ROUTING";
    	   ...
    	   System.out.println("5");
    		...
    		for(int i=0;i< categoryList.size();i++){	
    			...
    			String query = "INSERT INTO OPSBI_360_VIEW_CFD_ROUTING (REC_ID,QUERY_CD,CATEGORY_DATE,CFD_INCOMING,CFD_DISPOSED,CFD_BACKLOG) VALUES ('"+(i+1)+"','"+queryCD+"','"+categoryList.get(i)+"','"+ CFD_IncomingList.get(i)+"','"+CFD_DisposedList.get(i)+"','"+CFD_BacklogList.get(i)+"')";			
    			System.out.println("");
		...
		ROUTING_CFD_360_VIEW dna1= new ROUTING_CFD_360_VIEW(); 
		dna1.set_cqa_DNA();
