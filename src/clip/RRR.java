...
public class RRR {
	static String count,count1,count3,count4,count5,count7;
	static String access_Switching, core_Switching,Routing,Wireless,SPA,IOT;
   ...
   Thread.sleep(3000);
	...
	driver.get(DataBaseConnection.getURLFromDataBase("B2"));
...
driver.manage().window().maximize();
driver.get(DataBaseConnection.getURLFromDataBase("B11"));
Thread.sleep(6000);
driver.findElement(By.id("userInput")).sendKeys("akvangal");
driver.findElement(By.id("login-button")).click();
Thread.sleep(2000);
...
driver.manage().window().maximize();
driver.get(DataBaseConnection.getURLFromDataBase("B12"));
driver.findElement(By.id("userInput")).sendKeys("akvangal");
driver.findElement(By.id("login-button")).click();
Thread.sleep(2000);
driver.findElement(By.id("passwordInput")).sendKeys("Fcbarcelona!9");
...
driver.manage().window().maximize();
driver.get(DataBaseConnection.getURLFromDataBase("B13"));
driver.findElement(By.id("userInput")).sendKeys("akvangal");
driver.findElement(By.id("login-button")).click();
Thread.sleep(2000);
driver.findElement(By.id("passwordInput")).sendKeys("Fcbarcelona!9");
...
driver.manage().window().maximize();
driver.get(DataBaseConnection.getURLFromDataBase("B14"));
driver.findElement(By.id("userInput")).sendKeys("akvangal");
driver.findElement(By.id("login-button")).click();
Thread.sleep(2000);
driver.findElement(By.id("passwordInput")).sendKeys("Fcbarcelona!9");
...
driver.manage().window().maximize();
driver.get(DataBaseConnection.getURLFromDataBase("B16"));
driver.findElement(By.id("userInput")).sendKeys("akvangal");
driver.findElement(By.id("login-button")).click();
Thread.sleep(2000);
driver.findElement(By.id("passwordInput")).sendKeys("Fcbarcelona!9");
...
driver.manage().window().maximize();
driver.get(DataBaseConnection.getURLFromDataBase("B15"));
driver.findElement(By.id("userInput")).sendKeys("akvangal");
driver.findElement(By.id("login-button")).click();
Thread.sleep(2000);
driver.findElement(By.id("passwordInput")).sendKeys("Fcbarcelona!9");
...
System.out.println("3");
String query= "INSERT INTO OPSBI_360_WEEKLY_CLIP_TEST (REC_ID,QUERY_CD,PIN,TOTAL_COUNT) VALUES (1,'B2','Access-Switching','"+access_Switching+"')"; 
String query1= "INSERT INTO OPSBI_360_WEEKLY_CLIP_TEST (REC_ID,QUERY_CD,PIN,TOTAL_COUNT) VALUES (2,'B5','Core-Switching','"+core_Switching+"')";
String query2= "INSERT INTO OPSBI_360_WEEKLY_CLIP_TEST (REC_ID,QUERY_CD,PIN,TOTAL_COUNT) VALUES (3,'B6','Routing','"+Routing+"')";
String query3= "INSERT INTO OPSBI_360_WEEKLY_CLIP_TEST (REC_ID,QUERY_CD,PIN,TOTAL_COUNT) VALUES (4,'B7','Wireless','"+Wireless+"')";
String query4= "INSERT INTO OPSBI_360_WEEKLY_CLIP_TEST (REC_ID,QUERY_CD,PIN,TOTAL_COUNT) VALUES (5,'B8','IOT','"+IOT+"')";
//String query5= "INSERT INTO OPSBI_360_WEEKLY_CLIP_TEST (REC_ID,QUERY_CD,PIN,TOTAL_COUNT) VALUES (6,'B9','DNAC','"+DNAC+"')";
String query6= "INSERT INTO OPSBI_360_WEEKLY_CLIP_TEST (REC_ID,QUERY_CD,PIN,TOTAL_COUNT) VALUES (7,'B10','SPA','"+SPA+"')";
